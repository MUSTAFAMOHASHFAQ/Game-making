// --- Game Setup & Constants ---
        ...
        const SHOP_ITEMS = {
            'health_upgrade': {
                ...
                cost: [50, 100, 200], // Costs for L1, L2, L3
                stat: 'maxHits',
                maxLevel: 3,
                baseValue: 1,
                increment: 1,
        ...
        function handleCollision() { 
            ...
            if (whale.currentHits <= 0) {
                ...
                setTimeout(() => {
                    ...
                    totalScoreDisplay.textContent = `Total Points: ${totalPoints}`;
        ...
        function buyItem(itemId) {
            ...
            if (totalPoints >= cost) {
                ...
                totalScoreDisplay.textContent = `Total Points: ${totalPoints}`; // Update outside display
            } else {
        ...
        function renderShop() {
            shopTotalPointsDisplay.textContent = `Your Total Points: ${totalPoints}`;
            ...
            for (const itemId in SHOP_ITEMS) {
                ...
                let buttonText = isMax ? 'MAX LEVEL' : `BUY: ${cost}`;
        ...
        document.addEventListener('keydown', (e) => {
            // Only accept controls when game is not over AND shop is closed
            if (shopModal.classList.contains('visible') || isGameOver && !messageBox.classList.contains('visible')) return;
        ...
        window.onload = function() {
            ...
            messageBox.innerHTML = `
                ...
                <p>The whale can take **${playerUpgrades.maxHits} hit${playerUpgrades.maxHits > 1 ? 's' : ''}** before the game ends. Use the shop to upgrade!</p>
